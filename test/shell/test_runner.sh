...
# Converts a path to a Windows path if running under MSYS2.
#
# Prints the path unaltered otherwise. Necessary to avoid breakages like:
#
# - https://github.com/bazelbuild/continuous-integration/issues/2445
# - https://github.com/bazelbuild/bazel/issues/28406
#
